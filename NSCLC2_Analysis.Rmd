...
# Analizing TPM 
# TPM Analysis
```{r, fig.width=8, fig.height=12, Heatmap and dendrogram}
# Load clinical data 
...
TPM_clinical = TPM_forClustering
...
```{r}
# PCA biplot on TPM
pca_result <- FactoMineR::PCA(t(TPM_clinical), scale.unit = TRUE, graph = FALSE) # t(TPM) because PCA takes rows 
