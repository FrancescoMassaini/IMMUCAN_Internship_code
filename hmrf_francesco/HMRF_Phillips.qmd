...
```{r}
# Consider all patients as a single image

my_offset_file = data.table::data.table(patients = c(0, 1, 2, 3, 4, 5, 6),
...
my_offset_file = my_offset_file[,.(patients, x_offset_final, y_offset_final)]
