...
# Main function to process IF files for individual patientss
...
# Process each IF panel individually (BE CAREFUL TO RAM!)
process_individual_IF_files(IF_path, phenotype_keys_path, "IF1", save_files = TRUE)
process_individual_IF_files(IF_path, phenotype_keys_path, "IF2", save_files = TRUE)
process_individual_IF_files(IF_path, phenotype_keys_path, "IF3", save_files = TRUE)
